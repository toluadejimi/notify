        ...
        <div class="card-body">
            ...
            <form id="form" action="" method="post" role="form" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="title" name="title" class="form-control <?= \Altum\Alerts::has_field_errors('title') ? 'is-invalid' : null ?>" value="<?= $data->campaign->title ?>" maxlength="128" required="required" <?= $data->campaign->status == 'sent' ? 'disabled="disabled"' : null ?> />
                ...
                <div class="form-group">
                    ...
                    <input type="url" id="url" name="url" value="<?= $data->campaign->url ?>" class="form-control <?= \Altum\Alerts::has_field_errors('url') ? 'is-invalid' : null ?>" maxlength="512" placeholder="<?= l('global.url_placeholder') ?>" <?= $data->campaign->status == 'sent' ? 'disabled="disabled"' : null ?> />
                ...
                <div class="form-group" data-file-image-input-wrapper data-file-input-wrapper-size-limit="<?= settings()->websites->campaign_image_size_limit ?>" data-file-input-wrapper-size-limit-error="<?= sprintf(l('global.error_message.file_size_limit'), settings()->websites->campaign_image_size_limit) ?>">
                    ...
                    <?= include_view(THEME_PATH . 'views/partials/file_image_input.php', ['uploads_file_key' => 'websites_campaigns_images', 'file_key' => 'image', 'already_existing_image' => $data->campaign->image, 'input_data' => $data->campaign->status == 'sent' ? 'disabled="disabled"' : null]) ?>
                ...
                <div class="collapse" id="buttons_container">
                    ...
                    <div class="p-3 bg-gray-50 rounded mb-4">
                        ...
                        <div class="form-group">
                            ...
                            <input type="url" id="button_url_1" name="button_url_1" class="form-control <?= \Altum\Alerts::has_field_errors('button_url_1') ? 'is-invalid' : null ?>" value="<?= $data->campaign->settings->button_url_1 ?>" maxlength="512" placeholder="<?= l('global.url_placeholder') ?>" <?= $data->campaign->status == 'sent' ? 'disabled="disabled"' : null ?> />
                    ...
                    <div class="p-3 bg-gray-50 rounded mb-4">
                        ...
                        <div class="form-group">
                            ...
                            <input type="url" id="button_url_2" name="button_url_2" class="form-control <?= \Altum\Alerts::has_field_errors('button_url_2') ? 'is-invalid' : null ?>" value="<?= $data->campaign->settings->button_url_2 ?>" maxlength="512" placeholder="<?= l('global.url_placeholder') ?>" <?= $data->campaign->status == 'sent' ? 'disabled="disabled"' : null ?> />
