...
<div class="container">
    ...
    <div class="row mb-4">
        ...
        <div class="col-12 col-lg-auto d-flex d-print-none">
            ...
            <div class="ml-3">
                <button id="bulk_enable" type="button" class="btn btn-light <?= count($data->notification_handlers) ? null : 'disabled' ?>" data-toggle="tooltip" title="<?= l('global.bulk_actions') ?>"><i class="fas fa-fw fa-sm fa-list"></i></button>
